            ...
            <div class="header">
                ...
                <ul class="nav user-menu">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        >
                            <img
                                src="img/icons/notification-bing.svg"
                                alt="img"
                            />
                    ...
                    <div id="sidebar-menu" class="sidebar-menu">
                        <ul>
                            ...
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    ><img
                                        src="img/icons/expense1.svg"
                                        alt="img" /><span> Expense</span>
                                    <span class="menu-arrow"></span
                                ></a>
                                <ul>
                                    <li>
                                        <a href="expenselist.html"
                                            >Expense List</a
                                        >
                                    </li>
                                    <li>
                                        <a href="createexpense.html"
                                            >Add Expense</a
                                        >
                                    </li>
                                    <li>
                            ...
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    ><img
                                        src="img/icons/quotation1.svg"
                                        alt="img" /><span> Quotation</span>
                                    <span class="menu-arrow"></span
                                ></a>
                                <ul>
                                    <li>
                                        <a href="quotationList.html"
                                            >Quotation List</a
                                        >
                                    </li>
                                    <li>
                                        <a href="addquotation.html"
                                            >Add Quotation</a
                                        >
                                    </li>
                                </ul>
                            ...
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    ><img
                                        src="img/icons/places.svg"
                                        alt="img" /><span> Places</span>
                                    <span class="menu-arrow"></span
                                ></a>
                                <ul>
                                    <li>
                                        <a href="newcountry.html"
                                            >New Country</a
                                        >
                                    </li>
                                    <li>
                                        <a href="countrieslist.html"
                                            >Countries list</a
                                        >
                                    </li>
                                    <li>
